...
module.exports = function (options) {
	...
	var req_tags = options.req_tags || [];
	var res_tags = options.res_tags || [];
	...
	return function (req, res, next) {
		...
		res.end = function (chunk, encoding) {
			...
			if (typeof req_tags === 'function') {
				req_tags = req_tags(req);
				statTags = statTags.concat(req_tags);
			}

			if (typeof res_tags === 'function') {
				res_tags = res_tags(res);
				statTags = statTags.concat(res_tags);
			}
